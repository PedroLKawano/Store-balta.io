...
namespace Store.Tests.Domain
{
    ...
    public class OrderTests
    {
        ...
        {
            var order = new Order(_customer, 10, _discount); // -10 + 10 = 0
        ...
        {
            var expiredDiscount = new Discount(10, DateTime.Now.AddDays(-10)); // 0
            var order = new Order(_customer, 10, expiredDiscount); // +10 - 0
            order.AddItem(_product, 5); // 10*5 = 50
            Assert.AreEqual(60, order.Total()); // +10 + 50 = 60
        }

        [TestMethod]
        [TestCategory("Domain")]
        public void Dado_um_desconto_invalido_o_valor_de_um_produto_deve_ser_60()
        {
        ...
        [TestMethod]
        [TestCategory("Domain")]
        public void Dado_um_desconto_de_10_o_valor_de_um_pedido_deve_ser_50()
        {
